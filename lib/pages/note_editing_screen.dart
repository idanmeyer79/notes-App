...
class _NoteEditingScreenState extends State<NoteEditingScreen> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildImageSection(noteViewModel),
  ...
  Widget _buildImageSection(NoteViewModel noteViewModel) {
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
  ...
  Future<void> _pickImage(
    ...
    if (image != null) noteViewModel.setSelectedImage(image);
  }
  ...
  Future<void> _takePhoto(
    ...
    if (photo != null) noteViewModel.setSelectedImage(photo);
  }
}
